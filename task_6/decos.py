...
import sys
from log.server_log_config import logger as server_logger
from log.client_log_config import logger as client_logger
import traceback
import inspect
...
if sys.argv[0].find('client') == -1:
    ...
    CURRENT_LOGGER = server_logger
else:
    # ну, раз не сервер, то клиент
    CURRENT_LOGGER = client_logger
