...
from ..common.variables import RESPONSE, ERROR, USER, ACCOUNT_NAME, TIME, ACTION, PRESENCE, ENCODING_TYPE
...
class TestSocket:
    ...
    def send(self, message_to_send):
        ...
        # кодирует сообщение
        self.encoded_message = json_test_message.encode(ENCODING_TYPE)
    ...
    def recv(self, max_len):
        ...
        """
        json_test_message = json.dumps(self.test_dict)
        return json_test_message.encode(ENCODING_TYPE)
...
class Tests(unittest.TestCase):
    ...
    def test_send_message(self):
        ...
        # self.assertRaises(TypeError, send_message, test_socket, 1111)  # это не работает! TypeError не возникает
